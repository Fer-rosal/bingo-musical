  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-md w-full animate-fade-in">
        ...
        <a
          href="/api/auth/login"
          className="inline-flex items-center gap-3 bg-[#1DB954] hover:bg-[#1aa34a] text-black font-bold text-lg px-8 py-4 rounded-full transition-all duration-200 hover:scale-105 active:scale-95"
        >
